...
import { WatchLogQueue } from '../../domain/trakt/watch-queue.js';
...
export async function runLogwatchCli(rawArgs: string[] = process.argv.slice(2)): Promise<void> {
  const args = rawArgs;
...
export function handleLogwatchError(error: unknown): void {
