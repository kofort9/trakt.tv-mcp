...
**Steps (continued):** 5. Open https://trakt.tv/activate in a new browser tab 6. Log in to your Trakt.tv account (if not already logged in) 7. Enter the user code from step 4 8. Authorize the application
